...
function getCurrency():void{
    var nzd: string = (<HTMLInputElement>document.getElementById("nzdAmount")).value;
    var name: string = (<HTMLInputElement>document.getElementById("currency")).value;
    $symbol = name;
    if(nzd == "0" || nzd < "0"){
...
function calculation(rates){
    var nzAmount:number = (<HTMLInputElement>document.getElementById("nzdAmount")).valueAsNumber;
    var finalResult:number = nzAmount * rates;
